...
var createPatient=(req, res, next)=>{
    var obj={name:req.body.name, dob:req.body.dob, age:req.body.age, gender:req.body.gender,
        insType:req.body.insType, group:req.body.group, rel:req.body.rel, personCode:req.body.personCode, address:req.body.address}
...
module.exports={createPatient, getPatientDetails, getBookDetailsByid, updateBook, deelteBookDetails};