var  Prescriber= require('../models/prescriber.model');
...
var createPrescriber=(req, res, next)=>{
    var obj={name:req.body.name, license:req.body.license, phone:req.body.phone, npi:req.body.npi,
        dea:req.body.dea, address:req.body.address}
   
        Prescriber.create(obj, function(err, data){
...
var getPrescriberDetails=(req, res)=>{
    Prescriber.find()
    .then((result)=>{
        res.json({
...
module.exports={createPrescriber, getPrescriberDetails};